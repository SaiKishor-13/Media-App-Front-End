  ...
  return (
    <>
      <div className="d-flex align-items-center">
        <h5>Upload</h5>
        <button onClick={handleShow} className="btn btn-success ms-3 rounded-circle  fw-bolder">+</button>
      </div>
      ...
      >
        ...
        className="mb-3"
      >
        <Form.Control onChange={e=>setVideoDetails({...videoDetails,url:e.target.value})} type="text" placeholder="Image Link" />
      </FloatingLabel>
